...
<fieldset>
	...
	<div class="form-group">
	    ...
	    <input id="contrato_ini" name="contrato_ini" type="date" class="form-control input-md" value="{{ $result->contrato_ini }}" required>
	</div>
	<div class="form-group">
		<label class="control-label" for="fecha_fin">Fecha de terminación de contrato</label>  
	    <input id="contrato_fin" name="contrato_fin" type="date" class="form-control input-md" value="{{ $result->contrato_fin }}">
	</div>
